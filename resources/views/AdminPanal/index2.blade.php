...
@extends('AdminPanal.Admin_layout')
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" asset("admin/")dist/img/user3-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="{{asset("admin/dist/img/user3-128x128.jpg")}}"x alt="Product Image" class="img-size-50">
                    </div>
